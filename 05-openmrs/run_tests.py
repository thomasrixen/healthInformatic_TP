...
class Tests(unittest.TestCase):
    ...
    @classmethod
    def _compute_age(cls, birth_date):
        # https://stackoverflow.com/a/9754466
        born = cls.client.parse_date_time(birth_date)
        today = datetime.datetime.utcnow().replace(tzinfo=born.tzinfo)
    ...
    def test_create_patient(self):
        ...
        try:
            ...
            self.assertEqual(patient['person']['gender'], 'X')
            self.assertTrue(patient['person']['birthdate'].startswith('2001-01-03'))
            self.assertEqual(Tests._compute_age(patient['person']['birthdate']), patient['person']['age'])
    ...
    def test_find_patient(self):
        ...
        try:
            ...
            self.assertEqual(a[0]['age'], Tests._compute_age('2015-01-01T00:00:00.00+0000'))
            ...
            self.assertEqual(b[0]['age'], Tests._compute_age('2016-01-01T00:00:00.00+0000'))
    ...
    def test_notes(self):
        ...
        try:
            ...
            self.assertEqual(patient_info['gender'], 'X')
